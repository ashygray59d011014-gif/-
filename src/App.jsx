...
const CHARACTER_DIALOGUES = {
  ...
  "김현성": [
    {
     ...
     {
      text: "\"가끔... 아주 끔찍한 악몽을 꿉니다. 제가 모든 것을 잃고 혼자 남겨지는 꿈 말입니다.\"",
      choices: [
        { reply: "걱정 마세요. 이번에는 다를 겁니다.", nextText: "\"하하, 네...그 말씀 꼭 지키셔야 합니다.\"" },
        { reply: "숙면에 좋은 포션을 만들어 드릴까요?", nextText: "\"네, 네? 그... 제가 그런 걸 받아도 될지...\"" }
      ]
    },
     {
      text: "\"기영씨, 아재개그 좋아하십니까?\"",
      choices: [
        { reply: "하지 마세요.", nextText: "\"...넵.\"" },
        { reply: "들어나 봅시다.", nextText: "\"할아버지가 등산 하면?  ....산타 할아버지.  ........죄,죄송합니다.\"" }
      ]
    },
     {
      text: "\"기, 기영 씨!! 손가락에 피가...!! 당장 힐러! 아니, 교황을 당장 이곳으로 데려 오겠습니다!!\"",
      choices: [
        { reply: "진정하세요. 그냥 서류 보다가 종이에 살짝 베인 건데요...", nextText: "\"종이에 베인 상처로 파상풍에 걸려 사망한 사례가 역사서에 분명 존재합니다. 엘렉서를 가져오겠습니다.\"" },
        { reply: "아얏... 너무 아파요 현성 씨. 흑흑, 피가 안 멈추네요.", nextText: "\"당장 엘렉서를 가져오겠습니다!!\"" }
      ]
    },
     {
      text: "\"샤넬리아 에르메스의 가방의 디자인이 새로 나왔더군요. 관심 있으십니까?\"",
      choices: [
        { reply: "아니요, 괜찮아요.", nextText: "\"앗... 알겠습니다. 예약 주문은 취소해놓도록 하죠.\"" },
        { reply: "좋죠.", nextText: "\"후후, 분명 마음에 드실겁니다.\"" }
      ]
    },
    {
  ...
  "이기영": [
    {
      text: "\"꺼져...\"",
      choices: [
        { reply: "...", nextText: "\"거울 보고 혼잣말하는 기분이라 썩 좋지 않은데...베니고어나 보러 가야겠어.\"" }
      ]
    }
  ],
  ...
  "이지혜": [
    {
      text: "\"흐응, 오빠? 무슨 일 있어요?\"",
      choices: [
        { reply: "아무 일 없어.", nextText: "\"거짓말, 뭔가 바라는 게 있는 눈친데?\"" },
        { reply: "누나아아아아....", nextText: "\"응. 그래, 내 영혼의 단짝.\"" }
      ]
    },
    {
      text: "\"그 표정, 또 무슨 쓰레기 같은... 아니, 훌륭한 계획인지 나한테만 살짝 말해볼래요?\"",
      choices: [
        { reply: "역시 척하면 척이야.", nextText: "\"후후, 포장은 내가 완벽하게 해줄게.\"" },
        { reply: "억울하네, 아직 아무 것도 안 했는데.", nextText: "\"흥, 입에 침이나 바르고 거짓말 하세요.\"" }
      ]
    },
     {
      text: "\"오빠, 내가 진짜 오빠니까 이 정도로 해주는거야. 다른 사람이었으면 벌써 손절 쳤어. 알아?\"",
      choices: [
        { reply: "알지 알지!", nextText: "\"보상은 기대할께? 난 요즘 희라 언니가 들고 다니던 가방이 좋더라~\"" },
        { reply: "누나가 고생이 많아~", nextText: "\"으휴, 말만 잘 하지!\"" }
      ]
    }
  ],
  ...
  "정진호": [
    {
      text: "\"아, 마침 잘 오셨습니다. 안 그래도 어디서 무얼 하고 계신가... 아주 유심히 찾고 있었거든요.\"",
      choices: [
        { reply: "무슨 일 있나요?", nextText: "\"딱히 무슨 일이 있는 건 아니지만...\"" },
        { reply: "요즘 들어 조금 바쁘네요.", nextText: "\"흐음. 안색이 안 좋으시군요. 뒤통수라도 찔릴까 봐 밤잠을 설치셨습니까? 하하, 농담입니다.\"" }
      ]
    },
    {
      text: "\"제 마검이 오늘따라 피를... 아, 아니, 마력의 흐름이 아주 좋군요.\"",
      choices: [
        { reply: "그런가요?", nextText: "\"예. 기영씨는 안전하게 제 등 뒤에만 숨어 계시죠.\"" },
        { reply: "(...)", nextText: "\"하하, 너무 피하진 마시죠. 상처 받습니다.\"" }
      ]
    },
     {
      text: "\"휴우, 훌륭한 사냥이었습니다.\"",
      choices: [
        { reply: "임무 수고하셨어요.", nextText: "\"뼈와 살이 갈라지는 감각이 아주... 아, 기영씨가 듣기엔 좀 끔직한 이야기였습니까?\"" },
        { reply: "다 죽여놓고 오면 어떡하자는 겁니까?", nextText: "\"이런, 제가 손속이 좀 과했나봅니다. 앞으로 조심하죠. 아! 벌벌 떨며 구경만 하시느라 수고 많았습니다.\"" }
      ]
    }
  ],
   "조혜진": [
    {
      text: "\"도대체 길드마스터님은 부길마의 어떤 면을 보고 그렇게 맹목적으로 신뢰하시는 건지... \"",
      choices: [
        { reply: "저의 순수하고 헌신적인 마음씨 아닐까요?", nextText: "\"...헛소리하실 거면 가보겠습니다.\"" },
        { reply: "그렇게 궁금하면 현성 씨한테 직접 물어보시든가요.", nextText: "\"읏...! 방금 일은 없던 일로 하죠!\"" }
      ]
    },
    {
      text: "\"전투가 시작되면 절대 제 뒤에서 떨어지지 마십시오. 부길마님은 스치기만 해도 치명상 아닙니까.\"",
      choices: [
        { reply: "든든하네요. 혜진 씨만 믿고 뒤에서 응원하겠습니다.", nextText: "\"흠. 말은 참 잘하십니다.\"" },
        { reply: "혜진씨, 혹시 살인검술이라고 혹시 들어보셨습니까?", nextText: "\"...아, 됐다 그냥. 말을 말자.\"" }
      ]
    },
     {
      text: "\"저기, 부길마. 제 책상 위에 산더미처럼 쌓여있는 이 서류들은 뭡니까?\"",
      choices: [
        { reply: "우리 혜진 씨 능력이 출중해서 특별히 믿고 맡기는 겁니다. 파이팅!", nextText: "\"...입에 발린 소리 마십시오. 이번 한 번만 해드리는 겁니다. 다음엔 진짜 안 합니다.\"" },
        { reply: "그거 지혜 씨가 갖다둔 거 아닐까요?", nextText: "\"거짓말 마십시오. 방금 전까지 부원장님 결재 도장이 찍혀있던 걸 똑똑히 봤습니다만.\"" }
      ]
    }
  ],
     "한소라": [
    {
      text: "\"저, 부길드마스터님... 저 이번에 정말 열심히 일했는데, 며, 며칠만이라도 휴가 다녀오면 안 될까요...? \"",
      choices: [
        { reply: "휴가요? 그래요, 소라 씨도 쉴 땐 쉬어야죠.^^", nextText: "\"히익! 아, 아닙니다! 제가 잠깐 돌았나 봐요!\"" },
        { reply: "하얀이 허락은 받으면 보내줄게요.", nextText: "\"...그거 조용히 연구실로 돌아가라는 소리 아닌가요?\"" }
      ]
    },
    {
      text: "\"히익! 부, 부길드마스터님! 오, 오셨습니까! 저, 저는 아무것도... 아, 아니, 방금 전까지 아주 얌전히 연구만 하고 있었습니다!\"",
      choices: [
        { reply: "소라 씨, 왜 그렇게 떨어요? 제가 잡아먹기라도 합니까?", nextText: "\"아, 아닙니다! 그저 부원장님의 존안을 뵈어 너무 기쁜 나머지... 흑, 흐윽... 살려주세요...\"" },
        { reply: "수고가 많네요. 우리 하얀이 잘 챙겨주고 계시죠?", nextText: "\"네, 네에엡...!\"" }
      ]
    },
     {
      text: "\"요즘... 길드 내에서 부길마가 이번 기수 루키와 너무 붙어 다닌다는 소문이 돌고 있습니다. 하얀님 귀에 들어가기 전에 제가 입단속을 시키긴 했는데...\"",
      choices: [
        { reply: "역시 우리 소라 씨밖에 없네요. 보너스 챙겨드릴게요.", nextText: "\"보, 보너스보다... 제발 휴가... 아니, 안전 가옥 하나만 제공해 주시면!!\"" },
        { reply: "일부러 소문 좀 냅둬봐요. 하얀이가 어떻게 나오나 보게.", nextText: "\"이기영 부길마님 제발 저 살고 싶습니다!! 저 죽이시려고 이러시는 거죠?!\"" }
      ]
    }
  ],
       "김창렬": [
    {
      text: "\"부길드마스터. 지시하신 '청소'는 모두 끝났습니다. 흔적은 남기지 않았습니다.\"",
      choices: [
        { reply: "역시 창렬 씨네요.", nextText: "\"...충. 다음 지시를 내려주십시오.\"" },
        { reply: "혹시라도 꼬리를 밟히진 않았겠죠?", nextText: "\"걱정하지 않으셔도 됩니다. 목격할 만한 자들은... 제가 전부 '치웠으니까요'.\"" }
      ]
    },
    {
      text: "\"주변에 눈에 거슬리는 쥐새끼들이 몇 마리 숨어 있습니다. 지금 당장 목을 칠까요?\"",
      choices: [
        { reply: "일단은 그냥 두세요. 나중에 써먹을 데가 있을 테니까요.", nextText: "\"네.\"" },
        { reply: "네. 시끄러운 건 질색이니까 아주 조용히 처리해 줘요.", nextText: "\"금방 다녀오겠습니다.\"" }
      ]
    },
  ],
         ...
         "김예리": [
    {
      text: "\"아저씨. 나 이제 애 아냐. 머리 좀 그만 쓰다듬어...\"",
      choices: [
        { reply: "우리 예리, 사춘기 왔구나? 용돈이라도 올려줘야겠네.", nextText: "\"...용돈은 좋아.\"" },
        { reply: "알았어, 알았어. 우리 다 큰 훌륭한 예리 님.", nextText: "\"말투 진짜 맘에 안 들어. ...그래도 쓰다듬는 건 하루에 한 번만 봐줄게.\"" }
      ]
    },
    {
      text: "\"...저기 하얀 언니 또 아저씨 쪽으로 오는데? 아저씨 진짜 처신 똑바로 해. 나까지 피곤해지니까.\"",
      choices: [
        { reply: "예리가 아저씨 좀 숨겨줄래?", nextText: "\"아, 진짜 귀찮게! 빨리 내 망토 밑으로 숨어. ...오늘 간식은 최고급 마카롱으로 쏴야 돼.\"" },
        { reply: "너도 나중에 커서 연애하면 삼촌 마음 알게 될 거다.", nextText: "\"연애를 하면... 다 이렇게 되는 거야?\"" }
      ]
    },
  ],
